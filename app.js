document.addEventListener('DOMContentLoaded', () => {
  ...
  //finction that deals with all the outcomes of the snake
  ...
  function randomApple() {
    ...
    function control(e) {
        ...
        if (e.keyCode === 39) {
            direction = 1 //If wee press the right arrow, the snake will go right
            ...
            direction = +width //If we press down, the snake head will appear 10 div from where you are now
        }
    }
